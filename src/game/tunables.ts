...
const T = DebugPanel.define({
  ...
  advanced: {
    ...
    afkGoldPerSec: { value: 2, min: 0, max: 100, step: 1, label: 'AFK gold per second (base)' },
    afkXpPerSec: { value: 3, min: 0, max: 100, step: 1, label: 'AFK XP per second (base)' },
    afkGoldLevelMult: { value: 0.5, min: 0, max: 5, step: 0.1, label: 'AFK gold per level' },
    afkGoldStrMult: { value: 0.2, min: 0, max: 2, step: 0.05, label: 'AFK gold per STR' },
    afkXpLevelMult: { value: 0.8, min: 0, max: 5, step: 0.1, label: 'AFK XP per level' },
    afkXpStrMult: { value: 0.3, min: 0, max: 2, step: 0.05, label: 'AFK XP per STR' },
