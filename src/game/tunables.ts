...
const T = DebugPanel.define({
  ...
  advanced: {
    ...
    afkGoldPerSec: { value: 1, min: 0, max: 100, step: 1, label: 'AFK gold per second (base)' },
    afkXpPerSec: { value: 2, min: 0, max: 100, step: 1, label: 'AFK XP per second (base)' },
    afkGoldLevelMult: { value: 0.4, min: 0, max: 5, step: 0.1, label: 'AFK gold per level' },
    afkGoldStrMult: { value: 0.1, min: 0, max: 2, step: 0.05, label: 'AFK gold per STR' },
    afkXpLevelMult: { value: 0.5, min: 0, max: 5, step: 0.1, label: 'AFK XP per level' },
    afkXpStrMult: { value: 0.15, min: 0, max: 2, step: 0.05, label: 'AFK XP per STR' },
