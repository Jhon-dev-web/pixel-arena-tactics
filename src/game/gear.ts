...
export const GEAR: GearItem[] = [
  ...
  { id: 'bronze_dagger', slot: 'weapon', nameKey: 'bronze_dagger', descKey: 'bronze_dagger_d', materialKey: 'material_bronze', cost: 40, tier: 1, damage: 6, recipe: { materials: { iron: 2, leather: 1 } } },
  { id: 'iron_short_sword', slot: 'weapon', nameKey: 'iron_short_sword', descKey: 'iron_short_sword_d', materialKey: 'material_iron', cost: 120, tier: 2, damage: 15, critChance: 0.05, recipe: { items: { bronze_dagger: 2 }, materials: { iron: 3 } } },
  { id: 'steel_greatsword', slot: 'weapon', nameKey: 'steel_greatsword', descKey: 'steel_greatsword_d', materialKey: 'material_steel', cost: 300, tier: 3, damage: 30, recipe: { items: { iron_short_sword: 2 }, materials: { steel: 4, essence: 2 } } },
  { id: 'dragon_flameblade', slot: 'weapon', nameKey: 'dragon_flameblade', descKey: 'dragon_flameblade_d', materialKey: 'material_dragon', cost: 1000, tier: 4, damage: 45, burn: true, recipe: { items: { steel_greatsword: 1 }, materials: { dragon_scales: 3 }, shards: 5 } },
  ...
  { id: 'bronze_leather', slot: 'armor', nameKey: 'bronze_leather', descKey: 'bronze_leather_d', materialKey: 'material_bronze', cost: 50, tier: 1, maxHp: 25, recipe: { materials: { iron: 2, leather: 3 } } },
  { id: 'iron_chainmail', slot: 'armor', nameKey: 'iron_chainmail', descKey: 'iron_chainmail_d', materialKey: 'material_iron', cost: 130, tier: 2, maxHp: 60, resistance: 0.05, recipe: { items: { bronze_leather: 2 }, materials: { iron: 3 } } },
  { id: 'steel_plate', slot: 'armor', nameKey: 'steel_plate', descKey: 'steel_plate_d', materialKey: 'material_steel', cost: 350, tier: 3, maxHp: 120, reflect: 0.2, recipe: { items: { iron_chainmail: 2 }, materials: { steel: 4, essence: 2 } } },
  { id: 'dragon_scale_armor', slot: 'armor', nameKey: 'dragon_scale_armor', descKey: 'dragon_scale_armor_d', materialKey: 'material_dragon', cost: 1000, tier: 4, maxHp: 200, resistance: 0.1, recipe: { items: { steel_plate: 1 }, materials: { dragon_scales: 3 }, shards: 5 } },
  // Relics
