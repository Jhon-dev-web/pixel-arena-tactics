...
export const GEAR: GearItem[] = [
  ...
  { id: 'abyssal_bulwark', slot: 'armor', nameKey: 'abyssal_bulwark', descKey: 'abyssal_bulwark_d', materialKey: 'material_obsidian', iconUrl: Assets.gear_icons.armor_dragon.url, cost: 3300, tier: 6, maxHp: 440, resistance: 0.2, recipe: { items: { voidsteel_plate: 1 }, materials: { refined_obsidian: 2, concentrated_blood: 5 }, shards: 6, requiredLevel: 90 } },
  // Relics
